...
def test_and_evaluate_int8():
    print("=== 开始使用数据集评测 INT8 量化模型 ===")
    ...
    for i, case in enumerate(cases_to_test):
        ...
        try:
            ...
            print(f"Int8输出: {model_output[:60]}...")
    ...
    with open("int8_evaluation_results.json", "w", encoding="utf-8") as f:
        json.dump(results, f, indent=2, ensure_ascii=False)
    
    print("\n=== 评测完成 ===")
    print("评测结果已保存到 int8_evaluation_results.json 文件中，请打开查看并进行人工对比。")

if __name__ == "__main__":
    test_and_evaluate_int8()